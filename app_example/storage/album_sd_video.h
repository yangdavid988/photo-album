 ...
 *
 * A clip is a sub-folder of the card's MJPEG/ directory holding zero-padded,
 * sequentially numbered JPEG frames (the shape ffmpeg "frame_%06d.jpg"
...
/* List MJPEG/ sub-folders that hold numbered JPEG frames.  Does not mount —
 * the volume must already be up (album_sd_init).  @return clips found (0 if
 * none). */
